...
function ContributorModal({ user }: { user: User; }) {
    ...
    const isTestcordContributor = !!TestcordDevsById[user.id];
    const ContributedHyperLink = <Link href={isTestcordContributor ? "https://github.com/x2b1/TestCord" : "https://github.com/Equicord/Equicord"}>contributed</Link>;
