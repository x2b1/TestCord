 ...
 * DO NOT EDIT - This file is auto-generated from UncompressedImages.plugin.js
 */
...
const logger = new Logger("BD:Uncompressed_Images", "#ff7373");
...
BDPluginManager.loadPlugin("UncompressedImages.plugin.js", pluginCode);

export default definePlugin({
    name: "Uncompressed Images",
    description: "[BD] Hijacks the client cache & alters the low quality thumbnail image shown by default to the lossless version that was uploaded. V4 boasts a completely new approach that performs more similarly to native Discord, unlike V1-V3, which all infamously lagged due to excessive DOM manipulation.",
    authors: [{ name: "Knew", id: 0n }],
    version: "4.00",
