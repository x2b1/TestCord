 ...
 * DO NOT EDIT - This file is auto-generated from BetterFormattingRedux.plugin.js
 */
...
const logger = new Logger("BD:BetterFormattingRedux", "#ff7373");
...
BDPluginManager.loadPlugin("BetterFormattingRedux.plugin.js", pluginCode);

export default definePlugin({
    name: "BetterFormattingRedux",
    description: "[BD] Enables different types of formatting in standard Discord chat.",
    authors: [{ name: "Zerebos", id: 0n }],
    version: "2.3.15",
