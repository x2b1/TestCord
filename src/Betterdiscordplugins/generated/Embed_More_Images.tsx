 ...
 * DO NOT EDIT - This file is auto-generated from EmbedMoreImages.plugin.js
 */
...
const logger = new Logger("BD:Embed_More_Images", "#ff7373");
...
BDPluginManager.loadPlugin("EmbedMoreImages.plugin.js", pluginCode);

export default definePlugin({
    name: "Embed More Images",
    description: "[BD] Locally embeds images that are usually unembedded in the Discord client.",
