 ...
 * DO NOT EDIT - This file is auto-generated from SimpleAnimations.plugin.js
 */
...
const logger = new Logger("BD:SimpleAnimations", "#ff7373");
...
BDPluginManager.loadPlugin("SimpleAnimations.plugin.js", pluginCode);

export default definePlugin({
    name: "SimpleAnimations",
    description: "[BD] Simple CSS animations for Discord - works in browser context",
