...
const getChatInputText = () => {
    const chatInput = document.querySelector('div[contenteditable="true"][data-slate-node="text"], div[role="textbox"][data-slate-node="text"]');
    if (!chatInput) return "";
...
export default definePlugin({
    ...
    start: () => {
        console.log("[BetterFormattingRedux] Adding FormatButton to chat bar");
        addChatBarButton("FormatButton", FormatButton as any, FormatIcon);
    },
    stop: () => {
