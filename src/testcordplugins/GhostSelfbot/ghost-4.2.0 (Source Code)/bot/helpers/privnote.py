...
class Privnote:
    def __init__(self):
        ...
        self.saves = json.load(open(files.get_application_support() + "/data/privnote_saves.json", "r"))
    ...
    def save(self, note, link):
        ...
        json.dump(self.saves, open(files.get_application_support() + "/data/privnote_saves.json", "w"), indent=4)
