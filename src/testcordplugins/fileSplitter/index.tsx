...
copy /b "${file.name}.part1" + "${file.name}.part2"${
      chunks.length > 2 ? ' + "' + file.name + '.part3"' : ""
    }${chunks.length > 3 ? ' + "' + file.name + '.part4"' : ""}${
      chunks.length > 4 ? ' + "' + file.name + '.part5"' : ""
    }${chunks.length > 5 ? ' + "' + file.name + '.part6"' : ""}${
      chunks.length > 6 ? ' + "' + file.name + '.part7"' : ""
    }${chunks.length > 7 ? ' + "' + file.name + '.part8"' : ""}${
      chunks.length > 8 ? ' + "' + file.name + '.part9"' : ""
