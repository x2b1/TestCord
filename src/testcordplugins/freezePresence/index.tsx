    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: "shouldComponentUpdate($1){if($self.isFrozen()){if($1.channel.id!==this.props.channel.id)return true;if($1.version!==this.props.version)return false;return $1.rows!==this.props.rows||$1.groups.length!==this.props.groups.length;}return $1.channel.id!==this.props.channel.id||$1.version!==this.props.version||$1.groups.length!==this.props.groups.length}"
            }
        },
        {
